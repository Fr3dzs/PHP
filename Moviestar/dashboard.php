...
<div id="main-container" class="container-fluid">
    ...
    <p class="section-description">Adicione ou atualize os seus filmes favoritos</p>
            ...
            <tbody>
                <?php if(!empty($userMovies)): ?>
                    ...
                    <tr>
                        ...
                        <td><i class="fas fa-star"></i> <?= $movie->length ?></td>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="3" class="empty-list">Ainda não adicionaste nenhum filme!</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
